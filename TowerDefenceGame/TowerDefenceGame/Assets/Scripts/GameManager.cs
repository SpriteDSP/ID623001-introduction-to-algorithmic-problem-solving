...
/// </remarks>
// <summary>
/// This class controls the data of health, gold, and gameover states.
/// it will react when health is lost such as playing a sound effect and it will control the gameover if it loses all health
/// gold and health is managed here where it will invoke an event for the userinterface class to listen to
/// </summary>
