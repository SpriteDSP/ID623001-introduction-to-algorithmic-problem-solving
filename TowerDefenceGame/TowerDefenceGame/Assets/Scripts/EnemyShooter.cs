...
/// </remarks>
// <summary>
/// This class controls targeting the enemies in the regard that it keeps track of enemies that enter a monsters range, when a enemy is located, it will shoot bullet prefabs with a sound effect
/// the firing speed can be controlled and also varied through the monsterdata class
/// </summary>
